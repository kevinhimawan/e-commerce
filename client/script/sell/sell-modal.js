Vue.component('sell-modal',{
    template : `
        <div id="modal-sell" class="modal" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-sell-product">
                        <div class="modal-sell-product-left col-md-2">
                            <img class="card-img-top" v-for="(img,index) in specificshoe.images" v-if="index === 0" :src="img.path"  alt="">
                        </div>
                        <div class="modal-sell-product-middle col-md-6">
                            ...
                            <div v-if="infotrigger > 0 && modal.inputvalue != ''" class="modal-sell-product-middle-youraskinfo">
                                <div class="modal-sell-product-middle-youraskinfo-lowerthanbid" v-if="modal.inputvalue <= specificshoe.highestBid">
                                    <span>You're about to be the lowest Ask</span>
                                </div>
                                <div v-if="modal.inputvalue < specificshoe.lowestAsk" class="modal-sell-product-middle-youraskinfo-lowerthanask">
                                    <span>You're about to be the lowest Ask</span>
                                </div>
                                <div v-if="modal.inputvalue == specificshoe.lowestAsk" class="modal-sell-product-middle-youraskinfo-equaltoask">
                                    <span>You're about to match the lowest Ask. Their Ask will be accepted before yours</span>
                                </div>
                                <div v-if="modal.inputvalue > specificshoe.lowestAsk" class="modal-sell-product-middle-youraskinfo-higherthanask">
                                    <span>You're not the lowest ask</span>
                                </div>
                            </div>
                        ...
                        <div class="modal-sell-product-right col-md-4">
                            <div class="modal-sell-product-right-top">
                                <div class="dropdown show selectSizeDropDown col-md-6">
                                    ...
                                    <div style="width:260px" class="dropdown-menu selectSizeDropDown-menu" aria-labelledby="dropdownMenuLink">
                                        <div v-on:click="selectsize(size._id,index,size.eu)" v-for="(size,index) in specificshoe.size" class="selectSizeDropDown-menu-list">
                                            ...
                                            <div class="selectSizeDropDown-menu-market-info col-md-8">
                                                ...
                                                <div v-if="size.highestBid" class="selectSizeDropDown-menu-market-info-highesbid">
                                                    <h6 class="selectSizeDropDown-menu-market-info-font">Highest bid: {{size.highestBid}}</h6>
                                                </div>
                            ...
                            <div class="form-group" style="margin-bottom: 1rem;padding: 0 8px; margin-top:15px;">
                                <label style="margin-bottom:0" for="askinputsellmodal">Ask</label>
    ...
    methods:{
        selectsize:function(sizeid,index,sizename){
            this.$emit('changemodal',{size:sizename,index:index,sizeid:sizeid})
        },
        ...
        submitsell:function(){
            ...
            if(countBlank){
                ...
                axios.post('http://server-commerce.kevinhimawan.xyz/sell/addproduct',submitForm)
                .then(response=>{
