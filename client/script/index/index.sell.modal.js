Vue.component('index-sell-modal',{
  template : `
      <div id="indexmodalsell" class="modal" tabindex="-1" role="dialog">
                  ...
                  <div class="modal-body modal-sell-product">
                      ...
                      <div class="modal-sell-product-middle col-md-6">
                          ...
                          <div v-if="infotrigger > 0 && modal.inputvalue != ''" class="modal-sell-product-middle-youraskinfo">
                              ...
                              <div v-else-if="modal.inputvalue == specificshoe.lowestAsk" class="modal-sell-product-middle-youraskinfo-equaltoask">
                                  <span>You're about to match the lowest Ask. Their Ask will be accepted before yours</span>
                              </div>
                              <div v-else-if="modal.inputvalue > specificshoe.lowestAsk" class="modal-sell-product-middle-youraskinfo-higherthanask">
